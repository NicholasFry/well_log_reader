#this program will read las files for Gamma Ray and Porosity
#this program will allow the user to select a range of depths and provide an average of porosity and Gamma Ray values
##########################################################
...
import lasio 
import glob #more options in lasio docs for this
import numpy as np #numpy is a mathematics library in python used for statistics in the pdf report
import pandas as pd
...
from fpdf import FPDF #generate a formatted PDF report http://www.fpdf.org/ this creates a class according to docs
#Make the OOP
class Reader_cbl:
    def __init__(self, for_that_well):
        #when you set one of the args for __init__ equal to something this means it is a default
        self.self = self
